...
public class GeometryFragmentNew extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        try {
            ...
            final String[][] titles = {{"Square", "Rectangle", "Circle", "Ellipse", "Triangle", "Trapezoid", "Parallelogram", "Pentagon", "Hexagon", "Heptagon", "Octagon", "Nonagon", "Decagon"},
                    {"Cube", "Rectangular Prism", "Sphere", "Hemisphere", "Triangular Prism", "Pyramid (Triangular Base)", "Pyramid (Rectangular Base)", "Pentagonal Prism", "Cone", "Cylinder", "Regular Octahedron", "Dodecahedron", "Torus"},
                    {"Cube", "Rectangular Prism", "Sphere", "Hemisphere", "Triangular Prism", "Pyramid (Triangular Base)", "Pyramid (Rectangular Base)", "Pentagonal Prism", "Cone", "Cylinder", "Regular Octahedron", "Dodecahedron", "Torus"}};

            final String[][] areaTitles = {{"Side Length"}, {"Length", "Width"}, {"Radius"}, {"Major Radius", "Minor Radius"}, {"Base Length", "Height"}, {"Lower Base", "Upper Base", "Height"}, {"Length", "Height"},
                    {"Side Length", "Apothem"}, {"Side Length", "Apothem"}, {"Side Length", "Apothem"}, {"Side Length", "Apothem"}, {"Side Length", "Apothem"}, {"Side Length", "Apothem"}};

            final String[][] volumeTitles = {{"Side Length"}, {"Length", "Width", "Height"}, {"Radius"}, {"Radius"}, {"Base", "Length", "Height"}, {"Base Area", "Pyramid Height"},
                    {"Base Length", "Base Width", "Pyramid Height"}, {"Side Length", "Apothem", "Prism Height"}, {"Radius", "Height"}, {"Radius", "Height"}, {"Side Length"}, {"Side Length"}, {"Major Radius", "Minor Radius"}};

            final String[][] saTitles = {{"Side Length"}, {"Length", "Width", "Height"}, {"Radius"}, {"Radius"}, {"Base", "Length", "Height"}, {"Base Area", "Base Perimeter", "Slant Height"},
                    {"Base Length", "Base Width", "Pyramid Height"}, {"Side Length", "Apothem", "Prism Height"}, {"Radius", "Height"}, {"Radius", "Height"}, {"Side Length"}, {"Side Length"},
                    {"Major Radius", "Minor Radius"}};

            //final String[][][] allItemTitles = {areaTitles, volumeTitles, saTitles};
